          ...
          <div className="flex flex-col lg:flex-row gap-16 items-center">
            <div className="w-full lg:w-1/2">
              <div className="lg:max-w-lg">
                <div className="mb-6 text-center lg:text-left lg:text-nowrap">
                  <span className="text-sm font-semibold text-gaet-600 uppercase tracking-wider">
                    {t("homepage_about_us")}
                  </span>
                  <div>
                    <h2 className="text-3xl md:text-2xl lg:text-3xl font-bold mt-2">
                      {t("homepage_about_us_description_line1")}
                    </h2>
                    <h2 className="text-3xl md:text-2xl lg:text-3xl font-bold mt-2 lg:header-underline about-text-balanced">
                      {t("homepage_about_us_description_line2")}
                    </h2>
                  </div>
                </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-4 text-center">
              <div>
                ...
                <p className="text-gray-600">
                  {t("homepage_years_of_experience")}
                </p>
              </div>
              <div>
